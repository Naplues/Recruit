        ...
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-success">
                ...
                动态消息
                    <!-- Split button -->
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary">显示选项</button>
                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="caret"></span>
                            <span class="sr-only">Toggle Dropdown</span>
                        </button>
                        <ul class="dropdown-menu">
                            <li><a href="/company/load_infos/is_read" id="btn-is-read">已读</a></li>
                            <li><a href="/company/load_infos/un_read" id="btn-un-read">未读</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="/company/load_infos/all" id="btn-all">全部消息</a></li>
                        </ul>
                    </div>
                </div>
