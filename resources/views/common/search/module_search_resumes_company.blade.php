<div id="module_search_resumes" class="hide">
<br>
    <form action="/company/resume_search_details" method="GET">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-md-offset-0" >
                <button class="btn btn-danger btn-lg" type="submit" id="search">查找简历</button>
            </div>
