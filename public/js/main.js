...
/////////////////////////// 调用才会执行 ////////////////////////////////////
  ...
  function addParticipantsMessage (data) {     
    ...
    if (data.numUsers === 1) {
      ...
      message += "有 " + data.numUsers + " 人在聊天室中";
    }
    log(message);
  }
